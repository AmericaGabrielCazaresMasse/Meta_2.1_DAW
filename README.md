...
![Captura de la aplicación funcionando](meta2.1/Screenshot_Sitio.png)
...
│   │   └── logo.png
│   ├── components/
│   │   ├── AppHeader.vue        # Contiene la barra con el titulo
│   │   ├── AppFooter.vue        # Contiene el pie de pagina con datos del autor/a
...
- **`App.vue`**: componente raíz de la aplicación. Contiene `AppHeader`, `AppFooter` y `<router-view />` en medio, que es donde el router coloca la página actual.
...
- **`TablaDeDatos.vue`**: tabla estática con las habilidades técnicas del autor/a.
